...
class Arduino:
    ...
    def __init__(self, port="/dev/ttyUSB0", baudrate=57600, timeout=0.5, motors_reversed=False):
        ...
        self.PID_RATE = 36 # Do not change this!  It is a fixed property of the Arduino PID controller.
    ...
    def get_encoder_counts(self):
        ...
        if len(list(values)) != 3:
            ...
            print("encoder read value is {}".format(values))
            raise SerialException
            return None
        else:
    ...
    def drive(self, v0, v1, v2):
        ''' Speeds are given in encoder ticks per PID interval
        '''
        if self.motors_reversed:
            v0, v1, v2 = -v0, -v1, -v2
        return self.execute_ack('m %d %d %d' %(v0, v1, v2))
