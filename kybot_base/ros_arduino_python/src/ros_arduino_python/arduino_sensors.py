...
"""
    Sensor class for the arduino_python package
...
from ros_arduino_msgs.msg import Analog, AnalogFloat, Digital
...
class Sensor(object):
    def __init__(self, controller, name, pin, rate, frame_id, direction="input", node=None, **kwargs):
